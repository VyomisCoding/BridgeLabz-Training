...
1. Practiced programs using if-else, switch-case, for, and while loops
2. Worked on logical problems like leap year, prime number, BMI, grading system, and date calculation
